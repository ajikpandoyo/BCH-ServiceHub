...
<head>
  <meta charset="UTF-8">
  <title>Register | BCH LinkedBase</title>
...
<body>
  <div class="left">
    <div class="form-container">
      ...
      <p class="description">Register now to access BCH services and manage your bookings easily.</p>
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group">
          ...
          <i class="fa-solid fa-eye toggle-password" onclick="toggleConfirmPassword()" id="toggleConfirmIcon"></i>
        </div>
